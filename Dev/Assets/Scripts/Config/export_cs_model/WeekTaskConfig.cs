//跳转界面ID
//表名: 每周任务表, 字段描述：_key:ID, _icon:图标, _title:开启等级, _achieve_conditicon:任务标题, _achieve_type:数组, _parameter1:活动类型, _parameter2:参数, _parameter3:参数, _item1_id:条件参数, _item1_num:奖励物品1ID, _item2_id:奖励物品1数量, _item2_num:奖励物品2ID, _desc:奖励物品2数量, _skip_id:描述,  -->
using System;
...
public class WeekTaskConfigItem:ConfigDataItemBase{
...
public class WeekTaskConfig : ConfigDataBase<WeekTaskConfigItem> {
	public WeekTaskConfig(){
		_fileName = "export_xml/week_task_config.bytes";
	}
}