...
public class RedFruitConfigItem:ConfigDataItemBase{
...
public class RedFruitConfig : ConfigDataBase<RedFruitConfigItem> {
	public RedFruitConfig(){
		_fileName = "export_xml/red_fruit_config.bytes";
	}
}