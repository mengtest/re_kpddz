...
public class TimeTaskConfigItem:ConfigDataItemBase{
...
public class TimeTaskConfig : ConfigDataBase<TimeTaskConfigItem> {
	public TimeTaskConfig(){
		_fileName = "export_xml/time_task_config.bytes";
	}
}