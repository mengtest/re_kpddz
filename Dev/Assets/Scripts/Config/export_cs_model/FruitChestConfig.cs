...
public class FruitChestConfigItem:ConfigDataItemBase{
...
public class FruitChestConfig : ConfigDataBase<FruitChestConfigItem> {
	public FruitChestConfig(){
		_fileName = "export_xml/fruit_chest_config.bytes";
	}
}