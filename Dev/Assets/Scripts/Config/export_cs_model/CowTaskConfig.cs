//表名: 百人牛任务, 字段描述：_key:ID, _icon:图标, _account_level:开启等级, _pre_id:前置任务, _post_id:后置任务, _title:任务标题, _achieve_conditicon:数组, _achieve_condition_type:活动类型, _achieve_condition_param1s:参数1, _achieve_condition_param2s:参数2, _achieve_condition_param3s:参数3, _par:参数4, _item1_id:奖励物品1ID, _item1_num:奖励物品1数量, _desc:描述,  -->
using System;
...
public class CowTaskConfigItem:ConfigDataItemBase{
//	private System.Object _key;
	...
	private System.Object _par;
	/// <summary>
	/// 参数4
	/// </summary>
	public int par { get { return (int)_par; } }
	...
	public override void Parse(SecurityElement element) {
		...
		_par = Convert.ToInt32(element.Attribute("par"));base["par"]=_par;
...
public class CowTaskConfig : ConfigDataBase<CowTaskConfigItem> {
	public CowTaskConfig(){
		_fileName = "export_xml/cow_task_config.bytes";
	}
}