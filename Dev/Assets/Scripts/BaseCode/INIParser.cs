...
public class INIParser
{
	...
	private List<string> m_AllSections = new List<string> ();
	...
	{
		m_AllSections.Clear ();
		foreach (KeyValuePair<string, Dictionary<string,string>> item in m_Sections)
		{
			m_AllSections.Add (item.Key);
		}
		return m_AllSections;
	}

	public Dictionary<string, string> GetOneSection(string SectionName)
	{
		if (m_Sections.ContainsKey (SectionName))
