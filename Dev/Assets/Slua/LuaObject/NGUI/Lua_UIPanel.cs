...
public class Lua_UIPanel : LuaObject {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int get_fClipScale(IntPtr l) {
		try {
			UIPanel self=(UIPanel)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.fClipScale);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int set_fClipScale(IntPtr l) {
		try {
			UIPanel self=(UIPanel)checkSelf(l);
			System.Single v;
			checkType(l,2,out v);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"fClipScale",get_fClipScale,set_fClipScale,true);
