...
public abstract class UITweener : MonoBehaviour
{
    ...
    public delegate void onLuaFuncDelegate(GameObject go, float var);
    [HideInInspector]
    public onLuaFuncDelegate onUpdateCallback = null;
    ...
    public void SetOnUpdate(onLuaFuncDelegate del) { onUpdateCallback = del; }
	...
	public void Sample (float factor, bool isFinished)
	{
        ...
        {
            onUpdateCallback(gameObject, val);
        }
	}
	...
	/// </summary>
    /// 
    static public T BeginWithComp<T> (T comp, float duration) where T : UITweener
    {
        comp.mStarted = false;
