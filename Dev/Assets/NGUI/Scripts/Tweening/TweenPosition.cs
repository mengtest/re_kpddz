...
public class TweenPosition : UITweener
{
    ...
    static public TweenPosition BeginWithCompt (TweenPosition compt, float duration, Vector3 pos, bool worldSpace)
    {
        TweenPosition comp = UITweener.BeginWithComp<TweenPosition>(compt, duration);
        comp.worldSpace = worldSpace;
        comp.from = comp.value;
        comp.to = pos;
