...
public class UIWidget : UIRect
{
    ...
    {
        get { return null; }
        set { throw new System.NotImplementedException(GetType() + " has no alphaTexture setter"); }
    }
    ...
    bool IsUIButton()
    {
        UIButton pButton = gameObject.GetComponent<UIButton>();
        BoxCollider pBox = gameObject.GetComponent<BoxCollider>();
        if (pButton != null || pBox != null)
        {
            return true;
        }
        return false;
    ...
    virtual public void OnFill(BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols)
    {
        ...
        //         v0 = panel.worldToLocal.MultiplyPoint3x4(v0);
        //         v1 = panel.worldToLocal.MultiplyPoint3x4(v1);
        //         Vector3[] m_positionList = new Vector3[4];
        //         m_positionList[0] = new Vector3(v0.x, v0.y, v0.z);
        //         m_positionList[1] = new Vector3(v0.x, v1.y, v0.z);
        //         m_positionList[2] = new Vector3(v1.x, v1.y, v1.z);
        //         m_positionList[3] = new Vector3(v1.x, v0.y, v1.z);
        // 
        //         if (m_positionList == null || m_positionList.Length < 2)
        //             return;
        // 
        //         Color colF = color;
        //         colF.a = finalAlpha;
        // 
        //         float half_width = m_lineWidth / 2;
        // 
        ...
        //         mRect = NGUIMath.ConvertToTexCoords(mOuterUV, tex.width, tex.height);
        // 
        //         for (int i = 0; i < m_positionList.Length - 1; i++)
        //         {
        //             Vector3 line_dir = m_positionList[i + 1] - m_positionList;
        //             line_dir.Normalize();
        // 
        //             Vector3 up_offset = Vector3.Cross(line_dir, -Vector3.forward);
        //             Vector3 down_offset = Vector3.Cross(line_dir, Vector3.forward);
        // 
        //             Vector3 lt = m_positionList + up_offset * half_width;
        //             Vector3 rt = m_positionList[i + 1] + up_offset * half_width;
        //             Vector3 lb = m_positionList + down_offset * half_width;
        //             Vector3 rb = m_positionList[i + 1] + down_offset * half_width;
        // 
        //             verts.Add(lb);
        //             verts.Add(lt);
        //             verts.Add(rt);
